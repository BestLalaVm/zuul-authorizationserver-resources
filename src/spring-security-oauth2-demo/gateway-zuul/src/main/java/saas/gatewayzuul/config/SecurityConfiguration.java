...
import saas.gatewayzuul.components.DynamicOauth2ClientContextFilter;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        /**
         * 这个会比较简单点, 因为除了/authorization-server/**和/login, 其他都必须全都要认证.
         * 第二版本, 我们要求根据应用设置进行动态配置
         */
        http.authorizeRequests().antMatchers("/uaa/**", "/login")
    ...
    private RequestMatcher csrfRequestMatcher()
    {
        return new RequestMatcher() {
            ...
            //对如下URL禁用CSRF保护
            private final AntPathRequestMatcher[] requestMatchers = {new AntPathRequestMatcher("/authorization-server/**")};
